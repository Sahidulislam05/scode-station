        ...
        <footer className="border-t border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <FadeIn className="space-y-4">
                        ...
                        <p className="text-muted-foreground text-sm">
                            Empowering developers and businesses with cutting-edge tech solutions and education.
                        </p>
                    </FadeIn>
                    ...
                    <FadeIn delay={0.1} className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            <li>
                                <Link href="/agency" className="hover:text-primary transition-colors">
                                    Agency
                                </Link>
                            </li>
                            <li>
                ...
                <div className="mt-12 pt-8 border-t border-border/40 text-center text-sm text-muted-foreground">
                    <p>&copy; {new Date().getFullYear()} Scode Station. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
