  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        <div className="absolute top-[10%] right-[10%] w-125 h-125 bg-accent/5 rounded-full blur-[100px] opacity-40 animate-pulse" />
        <div className="absolute bottom-[20%] left-[20%] w-150 h-150 bg-primary/5 rounded-full blur-[120px] opacity-40" />
      </div>
        ...
        <StaggerContainer className="space-y-6 max-w-4xl">
          ...
          <FadeIn delay={0.2}>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Get personalized 1-on-1 mentorship from senior engineers at top
              tech companies. Break through plateaus and reach your potential.
            </p>
          </FadeIn>
          <FadeIn delay={0.3} className="pt-4">
            <Button
              size="lg"
              className="h-12 px-8 text-lg rounded-full shadow-lg shadow-primary/20"
            >
        ...
        <div className="text-center mb-16">
          <FadeIn>
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our mentorship process is designed to be simple, effective, and
              transformative.
            </p>
          </FadeIn>
        </div>
          ...
          {[
            {
              ...
              title: "Match",
              description:
                "We analyze your profile and goals to match you with the perfect mentor.",
              icon: UserPlus,
            },
            {
              step: "02",
              title: "Plan",
              description:
                "Co-create a personalized roadmap with your mentor to hit your targets.",
              icon: Target,
            },
            {
              step: "03",
              title: "Achieve",
              description:
                "Regular sessions and code reviews to ensure you stay on track and succeed.",
              icon: Trophy,
            },
          ].map((item, index) => (
            <FadeIn
              key={index}
              className="relative p-8 rounded-2xl bg-background border border-border hover:border-primary/50 transition-colors"
            >
              ...
              {[
                {
                  ...
                  text: "Weekly video calls focusing on your specific challenges.",
                },
                {
                  title: "Code Reviews",
                  text: "Get detailed feedback on your code to improve quality and patterns.",
                },
                {
                  title: "Career Advice",
                  text: "Resume reviews, mock interviews, and negotiation strategies.",
                },
                {
                  title: "Network Access",
                  text: "Connect with our exclusive community of high-performers.",
                },
              ].map((benefit, index) => (
