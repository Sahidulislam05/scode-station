        ...
        <StaggerContainer className="space-y-8 max-w-4xl">
          ...
          <FadeIn delay={0.2}>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We are a full-service creative agency specializing in custom
              software development, digital branding, and strategic innovation.
            </p>
          </FadeIn>
          <FadeIn
            delay={0.3}
          ...
          >
            <Link href="/contact">
              <Button
                size="lg"
                className="h-12 px-8 text-lg rounded-full shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all"
              >
                Start a Project
            ...
            >
              <Button
                variant="outline"
                size="lg"
                className="h-12 px-8 text-lg rounded-full hover:bg-muted/50 transition-colors"
              >
                View Portfolio
              </Button>
            </Link>
        ...
        <div className="text-center mb-16">
          <FadeIn>
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Comprehensive solutions tailored to your business needs, scalable
              and secure.
            </p>
          </FadeIn>
        </div>
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              description:
                "Data-driven strategies to grow your digital presence and market share.",
              icon: Rocket,
            },
            {
              title: "Custom Software",
              description:
                "Tailored software solutions to stream business processes and efficiency.",
              icon: Code,
            },
            {
              title: "UI/UX Design",
              description:
                "User-centric design that creates engaging and intuitive digital experiences.",
              icon: Code,
            },
            {
              title: "Cloud Solutions",
              description:
                "Scalable cloud infrastructure setup, management, and optimization.",
              icon: Globe,
            },
          ].map((service, index) => (
            <FadeIn
              key={index}
              className="group relative overflow-hidden rounded-2xl border border-border/50 bg-background/50 p-8 hover:border-primary/50 transition-colors duration-300"
            >
